...
const interfaceList = loadJsonFile('./docs/interfaces.json');
const events = loadJsonFile('./docs/events.json');
const messageTypes = loadJsonFile('./docs/message-types.json');
async function main() {
