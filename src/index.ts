...
import type { InterfaceInfo, MessageTypeInfo } from './types.js';

const interfaceList = interfaces as InterfaceInfo[];
const messageTypes = messageTypesRaw as MessageTypeInfo[];

async function main() {
  const server = new McpServer(
    { name: 'WFC MCP Server', version: '0.1.0' },
    { capabilities: { tools: {} } }
  );
